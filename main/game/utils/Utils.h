...
#include <cstdio>   // printf (traces de diagnostic temporaires)
...
namespace Utils {
    ...
    static void playSoundEffect(SoundEffects soundEffect) {
        ...
        printf("[SON] playSoundEffect(%d)\n", (int)soundEffect);   // trace temporaire de diagnostic
        switch (soundEffect) {
    ...
    static void playMusicStream(SoundEffects stream) {
        ...
        printf("[SON] playMusicStream(%d)\n", (int)stream);   // trace temporaire de diagnostic
